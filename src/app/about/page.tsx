...
const QandA = [
  {
    ...
    desc: "Amaz◯nで買い物している時に「どうやって動いてるのだろう」と興味を持ったのがきっかけです。10年前ぐらい。ちょうど世間にスマホが馴染み始めた頃だったので、今後はWebやアプリ開発は需要が高そうだ、と感じた。",
  },
  {
    icon: SquareArrowRight,
    color: "#e2699a",
    name: "次の目標",
    desc: "引き続きフロントエンド技術の向上、サブで3DやUX、興味のあるものを学習。技術だけでなく、新しい刺激や人とのつながりを通して表現の幅を広げていきたいです。",
  },
  {
    icon: Box,
    color: "#7d69e2",
  ...
  },
  {
    ...
    color: "#bdbdbd",
    name: "課題に感じていること",
    desc: "アプリケーション開発や上流工程にも関わっていきたい一方で、経験不足も感じています。将来的にはAI、バックエンド、テスト実装なども意識して学んでいきたい。",
  },
];
